...
const SupplyChart: React.FC<Props> = ({
  ...
  return (
    <>
      <div ref={containerRef} className="supplyChart">
        <HighchartsReact
          options={options}
        ...
        <div className="legend">
          {legendItems.map((s) => (
            <div key={s.id} className="legendItem">
              <div
              ...
              />
              <div className="legendItemName" style={{ color: COLORS.LABEL }}>
        ...
        <div className="markerLegend">
          {markers.map(([, title, subtitle], i) => (
            <div key={title} className="markerLegendItem">
              <div className="markerLegendCount">
                {String.fromCharCode(65 + i)}
              </div>
              <div>
                <div className="markerLegendTitle">{title}</div>
                <div className="markerLegendSubtitle">{subtitle}</div>{" "}
              </div>
            </div>
          ))}
        </div>
