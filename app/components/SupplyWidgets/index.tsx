...
import {
  EthSupplyParts,
  getEthSupply,
  getEthSupplyImprecise,
} from "~/api/eth-supply";
import type { EthPrice, GroupedAnalysis1 } from "~/api/grouped-analysis-1";
import { Scarcity } from "~/api/scarcity";
import { Eth } from "~/eth-units";
    ...
    <div className="flex flex-col gap-4 px-4 md:px-16">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="w-full">
          <EthSupplyWidget ethSupplyParts={ethSupplyParts}></EthSupplyWidget>
        </div>
        <div className="w-full">
