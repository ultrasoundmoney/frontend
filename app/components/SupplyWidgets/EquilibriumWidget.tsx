...
import { Eth, Gwei, GWEI_PER_ETH, WEI_PER_ETH } from "../../eth-units";
...
const BurnMarkers: FC<{ burnMarkers?: BurnMarkersProps }> = ({
  burnMarkers,
}) => {
...
const EquilibriumWidget: FC = () => {
  ...
  const [burnMarkers, setBurnMarkers] = useState<BurnMarkersProps>();
